...
| Part 1 | Part 2 |
| ------ | ------ |
| `37686` | `77204516023437` |

<h2>--- Day 13: Claw Contraption ---</h2><p>Next up: the lobby of a resort on a tropical island. The Historians take a moment to admire the hexagonal floor tiles before spreading out.</p>
<p>Fortunately, it looks like the resort has a new arcade! Maybe you can win some prizes from the claw machines?</p>
