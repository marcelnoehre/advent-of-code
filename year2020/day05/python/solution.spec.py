from solution import part_1, part_2, setup_seats
import unittest
import logging
...
class UnitTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open('../example.txt') as file:
            self.input = setup_seats([[line[:7], line[-3:]] for line in file.read().split('\n')])
    ...
    def test_part_1(self):
        ...
        try:
            solution_1, expected = part_1(self.input), 820
    ...
    def test_part_2(self):
        ...
        try:
            solution_2, expected = part_2(self.input), 566
